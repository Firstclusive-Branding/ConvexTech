...
const TermsAndCondition = () => {
  ...
  useEffect(() => {
    ...
    const fetchTerms = async () => {
      try {
        ...
        const termsData = res.data?.data?.[0]?.termsandconditions || [];
  ...
  return (
    <div className="terms-container">
      <h1>Terms and Conditions</h1>
      {loading ? (
        <div className="terms-loader-container">
        ...
        <>
          ...
          <p>
            ...
            services. By accessing or using this Site, you agree to be bound by
            these Terms. If you do not agree with any part of the Terms, you
