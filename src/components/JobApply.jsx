      ...
      <form className="jobapply-form" onSubmit={handleSubmit}>
        ...
        <div className="find-talent-checkbox">
          ...
          >
            ...
            conversations and follow-ups from ConvexTech. You can reply ‘STOP’
            at any time to opt out. Message and data rates may apply. Message
            frequency may vary; text HELP for assistance. For more information,
            please visit our <a href="/privacy-policy">Privacy Policy</a> and{" "}
